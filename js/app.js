...
function renderStats(){
  ...
  if(!el) return;
  const items=[{icon:'🎓',val:'10+',lbl:'Students Trained'},{icon:'🗂️',val:'100+',lbl:'Real Projects'},{icon:'🛠️',val:'11',lbl:'Tools Covered'},{icon:'🌐',val:'EN+ML',lbl:'Bilingual Sessions'},{icon:'⭐',val:'1:1',lbl:'Personal Sessions'},{icon:'📍',val:'Kerala',lbl:'India · Online'}];
...
function renderPacks(){
  ...
  const learningPacks=[
    ...
    {icon:"🗣️",name:"Interview Communication Pack",tagline:"Know your stuff. Now say it clearly.",
