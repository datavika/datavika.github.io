...
const DV = {
  ...
  hero: {
    stats: [
      { val:10,  suf:"+", label:"Students Trained"  },
  ...
  modules: [
    { id:"python",  icon:"python", name:"Python",           weeks:5,  fee:12000, tag:"Foundation"   },
    { id:"sql",     icon:"sql", name:"SQL",              weeks:3,  fee:8000,  tag:"Must-Have"    },
    { id:"excel",   icon:"excel", name:"Excel",            weeks:3,  fee:7500,  tag:"Job-Ready"    },
    { id:"powerbi", icon:"powerbi", name:"Power BI",         weeks:4,  fee:10500, tag:"Hot Skill"    },
    { id:"stats",   icon:"stats", name:"Statistics",       weeks:3,  fee:7500,  tag:"Core"         },
    { id:"da",      icon:"da", name:"Data Analysis",    weeks:4,  fee:10500, tag:"Essential"    },
    { id:"ml",      icon:"ml", name:"Machine Learning", weeks:6,  fee:14000, tag:"Career Boost" },
    { id:"dl",      icon:"dl", name:"Deep Learning",    weeks:4,  fee:11500, tag:"Advanced"     },
    { id:"nlp",     icon:"nlp", name:"NLP",              weeks:3,  fee:9000,  tag:"Trending"     },
    { id:"ip",      icon:"ip", name:"Image Processing", weeks:2,  fee:4500,  tag:"Specialist"   },
    { id:"aitools", icon:"aitools", name:"AI Tools",         weeks:2,  fee:4500,  tag:"NEW 2026"       },
  ],
  ...
  consulting: [
    { icon:"excel", title:"Power BI Dashboard",   desc:"Custom interactive dashboards for your business data.",     fee:"From Rs.8,000"  },
    { icon:"automation", title:"Excel Automation",      desc:"Automated reports, formulas and intelligent data systems.", fee:"From Rs.5,000"  },
    { icon:"strategy", title:"Data Strategy",        desc:"1-hr consultation + written data roadmap for your team.",  fee:"From Rs.4,000"  },
    { icon:"market", title:"Market Analysis",       desc:"Deep analysis of your sales, customers and market trends.", fee:"From Rs.8,000"  },
    { icon:"training", title:"Team Training",    desc:"Data literacy workshops for up to 15 staff members.",      fee:"From Rs.12,000" },
    { icon:"hiring", title:"Hiring Support",        desc:"Design assessments and shortlist data talent for your org.", fee:"From Rs.6,000" },
  ],
  ...
  cheatsheets: [
    { title:"Python",     icon:"python", topics:"Variables · Loops · Functions · Pandas · NumPy · OOP"        },
    { title:"SQL",        icon:"sql", topics:"Joins · Subqueries · Window Functions · CTEs · Aggregations" },
    { title:"Power BI",   icon:"powerbi", topics:"DAX · Power Query · Relationships · Visuals · RLS"           },
    { title:"Excel",      icon:"excel", topics:"XLOOKUP · Pivot Tables · Power Query · Dynamic Arrays"       },
    { title:"ML",         icon:"ml", topics:"Algorithms · Evaluation · Scikit-learn · XGBoost · SHAP"     },
    { title:"Statistics", icon:"stats", topics:"Distributions · Hypothesis Testing · A/B Testing · Bayesian" },
  ],
